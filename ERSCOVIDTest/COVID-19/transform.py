...
def transform_aabb(transform, aabb):
    ...
    #return [min_corner[0], min_corner[1], max_corner[0], max_corner[1]]#[x1, y1, x2, y2]
    return [z1, min_corner[1], min_corner[0], z2, max_corner[1], max_corner[0]]
